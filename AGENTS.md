...
Опубликованы ee8b421 — «Добавлен начальный каркас PowerDriveSim» и e8b1fee — «Добавлен метод интегрирования Trapezoidal». Следующий готовый шаг — обзорный README с реальными графиками. Проверять git log и origin/main.
## Стиль README
По уточнению пользователя 2026-09-15 README должен быть обзорным: назначение,
особенности, реальные результаты, что работает и короткая установка.
Не добавлять раздел «Технологии». Подробные инженерные команды — в docs и AGENTS.
График docs/images/reference-examples.png построен из CLI CSV и визуально проверен.
Воспроизведение: запустить rc-trapezoidal, rlc, switch в build/*.csv,
затем python docs/render_examples.py (для иллюстрации нужны matplotlib и numpy).