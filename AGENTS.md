...
Выполнены атомарный редактор Qt 6, визуальная иерархия, раскрываемые 2L VSI / 3L NPC, топологическая диагностика и тёмная тема. Приёмка M1: docs/verification-m1-acceptance.md. В M2 добавлены источники sine/pulse/PWL с точными фронтами и schema 8, три проверенных RC-примера. Следующие задачи — импорт табличной формы из файла и piecewise-linear полупроводники, затем расширение библиотеки преобразователей.
