...
Выполнены атомарный редактор Qt 6 и визуальные операции иерархии: public ports/parameters, grouping, open/edit/detach/expand, breadcrumbs, дерево и независимые графики экземпляров. Следующая задача — редактируемые составные преобразователи.
...
1. Атомарные 2L VSI и 3L NPC: отдельные switches, diodes, snubber, DC-link и внешние gates. Проверить изменённые топологии через общий solver.
...
- Визуальные операции иерархии и независимые настройки графиков экземпляров доступны. Пока нет 2L/NPC, машин и ускоренных backend.
