...
1. Дополнить topology analysis: идеальные source loops, токовые разрывы, состояния switches/diodes и адресная диагностика. Атомарные 2L/NPC уже реализованы и проверены.
