...
Выполнены атомарный редактор Qt 6 и основные визуальные операции иерархии: public ports/parameters, grouping, open/edit/detach/expand, breadcrumbs и дерево. Следующие задачи — независимые графики вложенных экземпляров и редактируемые составные преобразователи.
...
1. Завершить Scope в иерархии: окна из разных уровней одновременно, независимое сохранение вида экземпляров, публичные входы графиков. Проверить копирование и сериализацию настроек.
2. Проверить интерфейс иерархии на больших схемах, сохранение навигации и доступность команд при редактировании текста.
...
- Базовые визуальные операции иерархии доступны. При переходе между уровнями окна внутренних графиков пока закрываются; независимые настройки повторных экземпляров ещё требуют доработки. Пока нет 2L/NPC, машин и ускоренных backend.
