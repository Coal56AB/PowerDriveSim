...
Выполнены атомарный редактор Qt 6, визуальная иерархия и раскрываемые примеры 2L VSI / 3L NPC с независимыми плечами, диодами и RC-снабберами. Следующие задачи — топологическая диагностика, проверка больших схем и Stop, затем полная таблица M1.
...
2. Проверить интерфейс иерархии на больших схемах. Дерево уже сохраняет свёрнутые ветви и обновляется при изменении структуры; клавиши иерархии отключены при редактировании текста.
...
4. Сверить критерии M1 с фактическими проверками, включая GUI всех атомов инвертора и адресную навигацию к ошибкам вложенных схем.
