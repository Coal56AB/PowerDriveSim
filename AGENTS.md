...
Выполнены атомарный редактор Qt 6, визуальная иерархия, раскрываемые 2L VSI / 3L NPC, топологическая диагностика и тёмная тема. Приёмка M1: docs/verification-m1-acceptance.md. Следующая задача — источники AC/piecewise/pulse/sine для расширения библиотеки M2.
