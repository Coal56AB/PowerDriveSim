...
Проект развивается поэтапно. Работают редактор атомарных и иерархических схем, численное ядро и раскрываемые примеры 2L VSI и 3L NPC; расширенная библиотека преобразователей, электрические машины и ускоренные расчёты находятся в плане разработки.
