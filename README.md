...
Проект развивается поэтапно. Уже работает редактор атомарных схем и численное ядро; библиотека раскрываемых преобразователей, электрические машины и ускоренные расчёты находятся в плане разработки.
...
- размещение резисторов, конденсаторов, индуктивностей, источников, идеальных ключей и диодов на схеме;
...
- автоматическое определение проводящего и запертого состояния идеальных диодов;
...
Добавьте **«График»** из раздела «Измерения и графики» и соедините его входы с электрическими выводами, проводами, выходами датчиков или управляющими сигналами. Укажите время и шаг сверху, нажмите **«Пуск»**, затем откройте график двойным щелчком.
...
Ближайшие задачи — иерархические подсхемы и полностью редактируемые инверторы 2L VSI и 3L NPC. Далее запланированы библиотека преобразователей, электрические машины, механические нагрузки и ускорение расчётов.
