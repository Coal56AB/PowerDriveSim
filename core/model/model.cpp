...
Kind parse_kind(const std::string& s) {
    for(auto k : {Kind::resistor, Kind::capacitor, Kind::inductor, Kind::voltage, Kind::current, Kind::ideal_switch, Kind::diode, Kind::voltage_probe, Kind::current_probe, Kind::thyristor})
